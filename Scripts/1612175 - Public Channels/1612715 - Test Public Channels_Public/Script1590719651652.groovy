...
WebUI.click(findTestObject('Object Repository/Page_Town Square - TeamChuDeNC Mattermost/span_'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - TeamChuDeNC Mattermost/span_Create Channel'))

WebUI.setText(findTestObject('Object Repository/Page_Town Square - TeamChuDeNC Mattermost/input_Name_newChannelName'), name)
