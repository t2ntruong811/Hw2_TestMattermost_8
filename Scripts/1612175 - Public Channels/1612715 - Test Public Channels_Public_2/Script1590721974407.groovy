...
WebUI.setText(findTestObject('Page_Town Square - TeamChuDeNC Mattermost/textarea_tes'), purpose)

WebUI.setText(findTestObject('Object Repository/Page_Town Square - TeamChuDeNC Mattermost/textarea_tes_1'), header)
