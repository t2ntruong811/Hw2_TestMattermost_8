...
WebUI.click(findTestObject('Object Repository/Page_Mattermost - Join a team/span_'))
...
WebUI.setText(findTestObject('Page_Town Square - TeamChuDeNC Mattermost/input_httpsmadencchannels_form-control'), url)

WebUI.click(findTestObject('Page_Town Square - TeamChuDeNC Mattermost/span_Change Channel URL'))
