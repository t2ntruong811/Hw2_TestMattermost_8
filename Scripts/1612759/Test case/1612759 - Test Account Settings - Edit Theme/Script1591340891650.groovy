...
WebUI.click(findTestObject('Object Repository/Page_Town Square - t1 Mattermost/img_Organization_img-responsive'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - t1 Mattermost/span_Save'))
