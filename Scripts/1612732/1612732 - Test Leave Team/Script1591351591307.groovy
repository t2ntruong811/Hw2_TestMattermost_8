...
WebUI.click(findTestObject('Object Repository/Page_Town Square - abc Mattermost/span_Leave Team'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - abc Mattermost/span_Yes'))
